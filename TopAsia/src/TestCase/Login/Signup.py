...
class SignupFlow(unittest.TestCase):
    ...
    def test_Signup(self):
        ...
        popup_error_btn_confirm = UiObject(*SignupLocators.popup_error_btn_confirm)
        ...
        TEST_DATA = [
            ...
            [11, 'Data validation', 'VALID', password, password_error, 'Mật khẩu = 12 ký tự', 'sadfghjklqwe', ''],
            [12, 'Data validation', 'INVALID-P', password, password_error, 'Tài khoản đã tồn tại', '-', 'Tài khoản đã tồn tại'],
            [13, 'Data validation', 'INVALID', re_password, re_password_error, 'Mật khẩu nhập lại không trùng khớp', 'khongtrung', 'Mật khẩu nhập lại không trùng khớp'],
            [14, 'Data validation', 'VALID', re_password, re_password_error, 'Mật khẩu nhập lại trùng khớp', '123456', ''],
            [15, 'Data validation', 'INVALID', phoneno, phoneno_error, 'Không nhập số điện thoại', '', 'Vui lòng nhập số điện thoại'],
            [16, 'Data validation', 'INVALID', phoneno, phoneno_error, 'Số điện thoại ít hơn 10 ký tự', '123456789', 'Số điện thoại yêu cầu tối thiểu 10 ký tự'],
            [17, 'Data validation', 'VALID', phoneno, phoneno_error, 'Số điện thoại nhiều hơn 11 ký tự', '123456789145', ''],
            [18, 'Data validation', 'VALID', phoneno, phoneno_error, 'Số điện thoại có 10 ký tự', '1234567890', ''],
            [19, 'Data validation', 'VALID', phoneno, phoneno_error, 'Số điện thoại có 11 ký tự', '12345678901', ''],
            [20, 'Data validation', 'INVALID', phoneno, phoneno_error, 'Nhập chữ ở trường số điện thoại', '12345abcdef', 'Số điện thoại yêu cầu tối thiểu 10 ký tự'],
            [21, 'Data validation', 'VALID', phoneno, phoneno_error, 'Nhập chữ ở trường số điện thoại', '0935770998haha', ''],
            [22, 'Navigation', '0', username, password, 'Đăng ký khi uncheck Tôi đồng ý...', ['tuananhle_', '123456'], 'http://dev-ta.mooo.com'],
            [23, 'Navigation', '1', username, password, 'Đăng ký khi check Tôi đồng ý... Chuyển đến trang nạp tiền nếu đăng nhập thành công', ['tuananhle_', '123456'], 'http://dev-ta.mooo.com/account/deposit'],
            [24, 'Show/Hide pw', 'SHOW', password, show_pass, 'Click show/hide password icon sẽ hiển thị những ký tự đã nhập hoặc ẩn đi', '-', '-'],
            [25, 'Show/Hide pw', 'HIDE', password, hide_pass, 'Click show/hide password icon sẽ hiển thị những ký tự đã nhập hoặc ẩn đi', '-', '-'],
            [26, 'Show/Hide pw', 'SHOW', password, show_repass, 'Click show/hide nhập lại password icon sẽ hiển thị những ký tự đã nhập hoặc ẩn đi', '-', '-'],
            [27, 'Show/Hide pw', 'HIDE', password, hide_repass, 'Click show/hide nhập lại password icon sẽ hiển thị những ký tự đã nhập hoặc ẩn đi', '-', '-'],
            [28, 'Helptext', 'TEXT', username, None, 'Tên đăng nhập', '', 'Tên đăng nhập'],
            [29, 'Helptext', 'TEXT', password, None, 'Mật khẩu', '', 'Mật khẩu'],
            [30, 'Helptext', 'TEXT', re_password, None, 'Nhập lại mật khẩu', '', 'Nhập lại mật khẩu'],
            [31, 'Helptext', 'TEXT', phoneno, None, 'Số điện thoại', '', 'Số điện thoại'],
            [32, 'Helptext', 'TEXT', invite_code, None, 'Mã giới thiệu (Nếu có)', '', 'Mã giới thiệu (Nếu có)'],
        ]
