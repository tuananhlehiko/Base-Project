...
class RechargeBanksFlow(unittest.TestCase):
    ...
    def test_RechargeBankFlow(self):
        ...
        TEST_DATA = [
            ...
            [4, 'Data validation', 'INVALID', rl.in_amount, rl.in_amount_error, 'Nhập tiền nhiều hơn 1.000.000K', '1000001', ''],
            [5, 'Data validation', 'VALID', rl.in_amount, rl.in_amount_error, 'Nhập tiền bằng 1.000.000K', '1000000', 'Số tiền nạp tối đa là 1.000.000 K'],
            ...
            [8, 'Data validation', 'CHECK', rl.in_amount, rl.out_amount, 'Số tiền hiển thị phải tương đương với số tiền nhập', '1208', '1208000'],
