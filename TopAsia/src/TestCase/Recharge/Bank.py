...
class RechargeBanksFlow(unittest.TestCase):
    ...
    def test_RechargeBankFlow(self):
        ...
        TEST_DATA = [
            ...
            [6, 'Data validation', 'VALID-RAN', rl.in_amount, rl.in_amount_error, 'Nhập tiền lớn hơn 50k nhỏ hơn 1.000.000k', str(random.randrange(self.range[0], self.range[1])), ''],
            ...
            [11, 'Data validation', 'INVALID', rl.in_code, rl.in_code_error, 'Không nhập mã giao dịch', '', ''],
            ...
            [18, 'Data validation', 'CHECK-1-N-100', [rl.in_amount, rl.promo_100], [rl.amount_promo, rl.amount_real, rl.amount_minbet], 'Số tiền nhận được hiển thị phải được tính tương ứng với số tiền nhập và gói khuyến mãi', [50, 1000000], ''],
            [19, 'Data validation', 'CHECK-1-N-40', [rl.in_amount, rl.promo_40], [rl.amount_promo, rl.amount_real, rl.amount_minbet], 'Số tiền nhận được hiển thị phải được tính tương ứng với số tiền nhập và gói khuyến mãi', [50, 1000000], ''],
            [20, 'Data validation', 'CHECK-1-N-125', [rl.in_amount, rl.promo_125], [rl.amount_promo, rl.amount_real, rl.amount_minbet], 'Số tiền nhận được hiển thị phải được tính tương ứng với số tiền nhập và gói khuyến mãi', [50, 1000000], ''],
                        ...
                        if i[1] == 'Data validation':
                            if method == 'Cash' and (i[0] == 11 or i[0] == 12):
                                ...
                                if 'INVALID' in i[2]:
                                    ...
                                    if (i[0] == 9 and method == 'Cash') or i[0] == 11:
